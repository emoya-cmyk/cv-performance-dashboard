...
//
// Ported verbatim from cv-performance-dashboard's api/test/baselines.test.js;
// only the import was repointed at the package index (`..`) so the package's
// own `npm test` exercises the canonical module.
// ============================================================
