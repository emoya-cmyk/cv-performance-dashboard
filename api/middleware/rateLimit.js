...
// store; documented in HANDOFF as a scale-up note, not a launch blocker.)
//
// Test-safety: the DEFAULT skip bypasses the limiter under the test runner so
// the existing suite is never throttled, UNLESS a test opts in with
// FORCE_RATE_LIMIT=1 to exercise the 429 path. Callers that pass their own
// `skip` replace this entirely.
